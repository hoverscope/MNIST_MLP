...
Model Architecture and Two-Fold Testing:
...
Screenshot two-fold test process

Initalization and Hyperparameters:
...
![image](https://github.com/user-attachments/assets/64522c53-f211-49f5-b1bd-869313d902fb)
 ...
 Screenshot showing final value hyperparameters.
...
screenshot showing result of accuracy on test data set using two-fold test
![image](https://github.com/user-attachments/assets/54bcd591-200a-4e6e-9572-e692999db6fb)


 
screenshot showing training/learning process of the model on the training dataset
